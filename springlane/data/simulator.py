...
def _pick_basket_items(
    ...
    n_items = max(1, int(rng.normal(loc=2.8, scale=1.5))) #distribution normale de moyenne 2.8 et écart-type 1.5, arrondi à l'entier supérieur
    n_items = min(n_items, 8) #limite à 8 articles maximum pour éviter les paniers trop gros
